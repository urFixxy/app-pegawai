                    ...
                    <div class="sm:col-span-1">
                        ...
                        <div class="mt-1">
                            <input type="text" name="nama_lengkap" id="nama_lengkap" autocomplete="nama_lengkap"
                                value="{{ old('nama_lengkap', $employee->nama_lengkap) }}" required maxlength="100" class="block w-full p-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <div class="mt-1">
                            <input id="nomor_telepon" name="nomor_telepon" type="text" autocomplete="nomor_telepon"
                                value="{{ old('nomor_telepon', $employee->nomor_telepon) }}" required maxlength="15" class="block w-full p-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm
                                        ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2
                                        focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            @error('nomor_telepon')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
