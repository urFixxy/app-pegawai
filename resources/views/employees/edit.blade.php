                ...
                <div class="mt-3 grid grid-cols-1 gap-x-6 gap-y-3 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <div class="mt-1">
                            <input type="text" name="nama_lengkap" id="nama_lengkap"
                                value="{{ old('nama_lengkap', $employee->nama_lengkap) }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm
                    ...
                    <div class="sm:col-span-1">
                        <label for="email" class="block text-sm font-medium leading-6 text-gray-900">
                            Email address</label>
                        <div class="mt-1">
                            <input id="email" name="email" type="email" value="{{ old('email', $employee->email) }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm
                                    ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2
                                    focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <div class="mt-1">
                            <input id="nomor_telepon" name="nomor_telepon" type="text"
                                value="{{ old('nomor_telepon', $employee->nomor_telepon) }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm
                                    ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2
                                    focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <div class="mt-1">
                            <input id="tanggal_lahir" name="tanggal_lahir" type="date"
                                value="{{ old('tanggal_lahir', $employee->tanggal_lahir) }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm
                                    ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2
                                    focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <div class="mt-1">
                            <input id="tanggal_masuk" name="tanggal_masuk" type="date"
                                value="{{ old('tanggal_masuk', $employee->tanggal_masuk) }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm
                                    ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2
                                    focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <div class="mt-1">
                            <select id="department_id" name="department_id"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm
                                    ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                <option value="1" {{ old('department_id', $employee->department_id) == 1 ? 'selected' : '' }}>
                                    DTIK</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <div class="mt-1">
                            <select id="jabatan_id" name="jabatan_id"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm
                                    ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                <option value="1" {{ old('jabatan_id', $employee->jabatan_id) == 1 ? 'selected' : '' }}>Dosen
                                </option>
                            </select>
                        </div>
                    </div>
