        ...
        <div class="overflow-auto shadow sm:rounded-lg">
            <table class="min-w-full divide-y divide-gray-300">
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col" class="py-3.5 pl-4 pr-3 text-center text-sm font-semibold text-gray-900 sm:pl-6">Position</th>
                    ...
                    @foreach($position as $item)
                        <tr>
                            ...
                            <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-center text-sm font-medium sm:pr-6">
                                ...
                                <form action="{{ route('positions.destroy', $item->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
