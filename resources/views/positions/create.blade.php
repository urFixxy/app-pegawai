...
@section('content')
    <div class="mx-auto max-w-2xl px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-2xl font-bold mb-4 text-gray-800">Create Position</h1>
        <form action="{{ route('positions.store') }}" method="POST" class="bg-white p-3 rounded shadow-lg">
            @csrf
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 pb-12">
                    <div class="sm:col-span-1">
                        ...
                        <div class="mt-1">
                            <input type="text" name="nama_jabatan" id="nama_jabatan" autocomplete="nama_jabatan"
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <div class="mt-1">
                            <input type="text" name="gaji_pokok" id="gaji_pokok" autocomplete="gaji_pokok"
                                class="block w-full p-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm
                                               ring-1 ring-inset ring-gray-300 placeholder:text-gray-400
                                               focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 focus:outline-none">
                        </div>
