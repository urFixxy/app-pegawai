                ...
                <div class="border-b border-gray-900/10 pb-12">
                    <div class="mt-3 grid grid-cols-1 gap-x-6 gap-y-3 sm:grid-cols-2">
                        <div class="sm:col-span-1">
                            <label for="karyawan_id" class="block text-sm font-medium leading-6 text-gray-900">Employee
                                ID</label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-1">
                            <label for="gaji_pokok" class="block text-sm font-medium leading-6 text-gray-900">Basic
                                Salary</label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-1">
                            <label for="tunjangan"
                                class="block text-sm font-medium leading-6 text-gray-900">Allowance</label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-1">
                            <label for="potongan"
                                class="block text-sm font-medium leading-6 text-gray-900">Deduction</label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-1">
                            <label for="total_gaji" class="block text-sm font-medium leading-6 text-gray-900">Total
                                Salary</label>
                            <div class="mt-1">
